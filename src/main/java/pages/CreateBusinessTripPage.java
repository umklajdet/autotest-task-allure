...
public class CreateBusinessTripPage extends BasePage {
    ...
    @Step("Открывает список подразделений")
    ...
    @Step("Проверки заполнения полей (Значения, выбранные из выпадающего списка)")
    ...
    @Step("Проверки заполнения полей (Значения, введенные с клавиатуры)")
    ...
    @Step("Проверки заполнения полей (Отмеченные чекбоксы)")
    ...
    @Step("Попытка сохранить комндировку")
